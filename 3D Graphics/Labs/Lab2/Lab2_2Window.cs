...
namespace Labs.Lab2
{
    public class Lab2_2Window : GameWindow
    {
        ...
        protected override void OnRenderFrame(FrameEventArgs e)
        {
            ...
            Matrix4 m1Trans = Matrix4.CreateTranslation(0.5f, 0, 0);
            Matrix4 m1Rot = Matrix4.CreateRotationZ(0.8f);
            Matrix4 m1 = Matrix4.Mult(m1Rot, m1Trans);
            ...
            Matrix4 m2Rot = Matrix4.CreateRotationZ(0.8f);
            Matrix4 m2Trans = Matrix4.CreateTranslation(-0.5f, 0, 0);
            Matrix4 m2 = Matrix4.Mult(m2Trans, m2Rot);
