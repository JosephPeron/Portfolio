...
namespace Labs.Lab4
{
    public class Lab4Window : GameWindow
    {
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            //Added texture coordinates to vertices – mesh is broken
            ...
            string filepath = @"C:\Users\Fierce\Desktop\New folder (2)\Startup Code 3D Graphics\Labs\Lab4\texture.jpeg";
            ...
            string filepath2 = @"C:\Users\Fierce\Desktop\New folder (2)\Startup Code 3D Graphics\Labs\Lab4\rain.jpeg";
            if (System.IO.File.Exists(filepath2))
            {
                ...
                TextureBitmap.UnlockBits(TextureData);
                TextureBitmap.RotateFlip(RotateFlipType.RotateNoneFlipY);
                // Flipped the image before loading onto the graphics card
                int uTextureSamplerLocation = GL.GetUniformLocation(mShader.ShaderProgramID, "uTextureSampler2");
                GL.Uniform1(uTextureSamplerLocation, 0);
                //Used second texture to discard some fragments creating a dissolve effect
            }
            else
            {
        ...
        protected override void OnRenderFrame(FrameEventArgs e)
        {
            ...
            // if change draw type to triangle strips, can see square is made up of multiple smaller triangles
            GL.BindVertexArray(0);
            this.SwapBuffers();
        }
